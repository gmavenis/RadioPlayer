...
cflags_array_features	:= -DAAC_ARRAY_FEATURES='0x00$(foreach feature,$(AAC_DECODER_FEATURES), | com_biophysics_radioplayer_Decoder_DECODER_$(feature))' $(foreach feature,$(AAC_DECODER_FEATURES),-DAAC_ARRAY_FEATURE_$(feature))
