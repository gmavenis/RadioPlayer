...
/* Header for class com_biophysics_radioplayer_MMSInputStream */

#ifndef _Included_com_biophysics_radioplayer_MMSInputStream
#define _Included_com_biophysics_radioplayer_MMSInputStream
...
/*
 * Class:     com_biophysics_radioplayer_MMSInputStream
